...
import com.wngud.compose1.ui.theme.Compose1Theme
...
@Composable
fun problem1(modifier: Modifier = Modifier) {
...
@Composable
fun problem2(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxWidth()
            .fillMaxHeight(),
...
@Composable
fun composeCard(bgColor: Color, text1: String, text2: String, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize()
            .background(bgColor)
